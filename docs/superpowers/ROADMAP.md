...
| **D2.1 — Minimal graphical match** | Lean argv-driven graphical match (`aplicacion agentA.py agentB.py`): IrrlichtMt window, textured 3D board + 81 cells + two pawns + static torches, full AI-vs-AI match to "Hay un ganador!". Menu/animation/GUI deferred (KB-D2-001..006). | ✅ Done | [plan](plans/2026-05-30-phase-d2.1-graphical-match.md), **[PR #8](https://github.com/fabzter/quassimodo/pull/8) (open)** |
