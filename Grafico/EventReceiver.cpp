...
Grafico::EventReceiver::EventReceiver()
{
...
bool Grafico::EventReceiver::OnEvent(const SEvent& event)
{
...
const Grafico::SMouseState& Grafico::EventReceiver::GetMouseState(void) const
{
	return MouseState;
}
bool Grafico::EventReceiver::IsKeyDown(EKEY_CODE keyCode) const
{
