...
LDLIBSOPTIONS=-Wl,-rpath ../Reglas/dist/Debug/GNU-Linux-x86 -L../Reglas/dist/Debug/GNU-Linux-x86 -lReglas

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Debug.mk dist/Debug/GNU-Linux-x86/libAgentes.so

dist/Debug/GNU-Linux-x86/libAgentes.so: ../Reglas/dist/Debug/GNU-Linux-x86/libReglas.so

dist/Debug/GNU-Linux-x86/libAgentes.so: ${OBJECTFILES}
...
${OBJECTDIR}/AgenteMinimax2.o: AgenteMinimax2.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I.. -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/AgenteMinimax2.o AgenteMinimax2.cpp

${OBJECTDIR}/ManejadorAgentes.o: ManejadorAgentes.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I.. -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/ManejadorAgentes.o ManejadorAgentes.cpp
...
${OBJECTDIR}/AgenteHumano.o: AgenteHumano.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I.. -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/AgenteHumano.o AgenteHumano.cpp
...
${OBJECTDIR}/AgenteMinimax4.o: AgenteMinimax4.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I.. -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/AgenteMinimax4.o AgenteMinimax4.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Debug
	${RM} dist/Debug/GNU-Linux-x86/libAgentes.so
