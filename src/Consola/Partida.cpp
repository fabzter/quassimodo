...
bool Partida::siguienteJugada()
{
    ...
    // Per the header contract: true if the match continues, false if it ended
    // (e.g. a winner). The original code omitted this return (UB; modern clang
    // traps on the fall-off-end), which crashed the match after the first move.
