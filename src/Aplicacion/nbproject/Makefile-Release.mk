...
LDLIBSOPTIONS=-L/usr/lib/irrlicht -L../lib -L./lib -Wl,-rpath . -Wl,-rpath ./lib -Wl,-rpath ../Grafico/dist/Debug/GNU-Linux-x86 -L../Grafico/dist/Debug/GNU-Linux-x86 -lGrafico -Wl,-rpath ../Reglas/dist/Debug/GNU-Linux-x86 -L../Reglas/dist/Debug/GNU-Linux-x86 -lReglas -Wl,-rpath ../Opciones/dist/Debug/GNU-Linux-x86 -L../Opciones/dist/Debug/GNU-Linux-x86 -lOpciones -lIrrlicht -lboost_filesystem-mt -lboost_system-mt -Wl,-rpath ../Agentes/dist/Debug/GNU-Linux-x86 -L../Agentes/dist/Debug/GNU-Linux-x86 -lAgentes -lboost_thread-mt -lIrrKlang
...
dist/Release/GNU-Linux-x86/aplicacion: ../Agentes/dist/Debug/GNU-Linux-x86/libAgentes.so
