...
scene::IAnimatedMeshSceneNode *Grafico::Pieza::getNodo() { return this->nodoA; }
...
void Grafico::Pieza::dibuja(scene::ISceneManager *smgr) {
  ...
  this->nodoA->getMaterial(0).Lighting = false;
...
void Grafico::Pieza::setMesh(scene::IAnimatedMesh *mesh) { this->mesh = mesh; }
...
scene::ISceneNode *Grafico::Pieza::getNodoSombra() { return this->sombra; }