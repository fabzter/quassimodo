...
void Grafico::Skin::setTablero(scene::ISceneManager* smgr){
    ...
    {
        io::IReadFile* rf = this->fsys->createAndOpenFile(this->opciones->getTableroModeloPath().c_str());
        this->Tablero = rf ? smgr->getMesh(rf) : nullptr;
        if (rf) rf->drop();
    }
...
void Grafico::Skin::setJugadores(scene::ISceneManager* smgr){
     ...
     {
         io::IReadFile* rf = this->fsys->createAndOpenFile(this->opciones->getJugador2ModeloPath().c_str());
         this->Jugador2 = rf ? smgr->getMesh(rf) : nullptr;
         if (rf) rf->drop();
     }
     ...
     {
         io::IReadFile* rf = this->fsys->createAndOpenFile(this->opciones->getJugador1ModeloPath().c_str());
         this->Jugador1 = rf ? smgr->getMesh(rf) : nullptr;
         if (rf) rf->drop();
     }
     ...
     {
         io::IReadFile* rf = this->fsys->createAndOpenFile(this->opciones->getJugadorSombraModeloPath().c_str());
         this->SombraJugador = rf ? smgr->getMesh(rf) : nullptr;
         if (rf) rf->drop();
     }
...
void Grafico::Skin:: setAntorcha(scene::ISceneManager* smgr){
    std::ostringstream strs;
    {
        io::IReadFile* rf = this->fsys->createAndOpenFile(this->opciones->getAntorchaModeloPath().c_str());
        this->Antorcha = rf ? smgr->getMesh(rf) : nullptr;
        if (rf) rf->drop();
    }
...
void Grafico::Skin::setBarrera(scene::ISceneManager* smgr){
    std::ostringstream strs;
    {
        io::IReadFile* rf = this->fsys->createAndOpenFile(this->opciones->getBarreraModeloPath().c_str());
        this->Barrera = rf ? smgr->getMesh(rf) : nullptr;
        if (rf) rf->drop();
    }
...
void Grafico::Skin::setCelda(scene::ISceneManager* smgr){
    std::ostringstream strs;
    {
        io::IReadFile* rf = this->fsys->createAndOpenFile(this->opciones->getCeldaModeloPath().c_str());
        this->Celda = rf ? smgr->getMesh(rf) : nullptr;
        if (rf) rf->drop();
    }
